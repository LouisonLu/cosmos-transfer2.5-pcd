...
def main(
    ...
    from cosmos_transfer2.inference_hardlock_off import Control2WorldInferenceHardlockOff

    inference = Control2WorldInferenceHardlockOff(args.setup, batch_hint_keys=batch_hint_keys)
    inference.inference_pipeline.force_hardlock_first_chunk = False
    log.info("First-chunk hard lock is disabled for this inference entry point.")

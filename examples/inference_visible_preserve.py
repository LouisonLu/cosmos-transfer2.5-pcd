...
def main(
    ...
    from cosmos_transfer2.inference_visible_preserve import Control2WorldInferenceVisiblePreserve

    inference = Control2WorldInferenceVisiblePreserve(args.setup, batch_hint_keys=batch_hint_keys)

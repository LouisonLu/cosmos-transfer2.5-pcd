...
class ControlVideo2WorldRectifiedFlowFrame0SpatialLockConfig(Video2WorldModelRectifiedFlowConfig):
...
class ControlVideo2WorldModelRectifiedFlowFrame0SpatialLock(Video2WorldModelRectifiedFlow):
    """
    ImaginaireModel instance of the VACE-styled controlnet for training.
    """

    def __init__(self, config: ControlVideo2WorldRectifiedFlowFrame0SpatialLockConfig, *args, **kwargs):

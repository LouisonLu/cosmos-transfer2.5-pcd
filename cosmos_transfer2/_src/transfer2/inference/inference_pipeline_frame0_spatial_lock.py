...
class ControlVideo2WorldInferenceFrame0SpatialLock:
    """
    ...
    def generate_img2world(
        ...
        with _maybe_get_timer(self.benchmark_timer, "preprocessing"):
            ...
            force_hardlock_first_chunk = getattr(self, "force_hardlock_first_chunk", True)
            if force_hardlock_first_chunk:

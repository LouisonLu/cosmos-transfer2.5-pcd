...
"""Single-view config for inference-time frame0 visible-region spatial lock."""
...
transfer2_singleview_frame0_spatial_lock_pcd_rgb_image_context_example = dict(
    defaults=[
        DEFAULT_BASE_EXPERIMENT,
        {"override /model": "fsdp_control_vace_rectified_flow_frame0_spatial_lock"},
    ...
    job=dict(
        ...
        name="transfer2_singleview_frame0_spatial_lock_pcd_rgb_image_context_example",
    ),
    checkpoint=dict(
        save_iter=1000,
...
for _item in [transfer2_singleview_frame0_spatial_lock_pcd_rgb_image_context_example]:

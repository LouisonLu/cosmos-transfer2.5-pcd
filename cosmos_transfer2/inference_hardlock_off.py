...
from cosmos_transfer2._src.transfer2.inference.inference_pipeline_hardlock_off import (
    ControlVideo2WorldInferenceHardlockOff,
)
...
class Control2WorldInferenceHardlockOff:
    def __init__(
        self,
        args: SetupArguments,
        ...
        self.inference_pipeline = ControlVideo2WorldInferenceHardlockOff(
            # pyrefly: ignore [bad-argument-type]
